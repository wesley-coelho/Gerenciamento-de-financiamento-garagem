 ...
 * @author Wesley
 */
public class FormPesquisaEntrada extends javax.swing.JInternalFrame {
    Usuario usuario = new Usuario();
    List<EntradaVeiculo> entradas;
    int iteratorLista = 0;
    /**
     * Creates new form FormNovaEntrada
     */
    public FormPesquisaEntrada(Usuario user) {
        this.usuario = user;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        cbCidadeEntrada.setEditable(true);
    ...
    private void btnImprimirEntradaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirEntradaActionPerformed
        try{ 
            PrinterJob job = PrinterJob.getPrinterJob();
                        job.setPrintable(new PrintingEntradaVeiculo(entradas.get(iteratorLista)));
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        EntradaVeiculo.janelaPesquisarEntrada = true;
        System.out.println(EntradaVeiculo.janelaPesquisarEntrada);
    ...
    private void formInternalFrameClosed(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameClosed
        // TODO add your handling code here:
        EntradaVeiculo.janelaPesquisarEntrada = false;
    ...
    private void btnNextResultActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNextResultActionPerformed
        // TODO add your handling code here:
        if(iteratorLista+1 < this.entradas.size()){
    ...
    private void preencheResultadoConsulta(int i){
        this.lblAtualResult.setText(String.valueOf(i + 1));
                this.txtMarcaEntrada.setText(entradas.get(i).getMarca());
                this.txtModeloEntrada.setText(entradas.get(i).getModelo());
                this.txtRenavamEntrada.setText(entradas.get(i).getRenavam());
                this.txtChassiEntrada.setText(entradas.get(i).getChassi());
                this.txtPlacaEntrada.setText(entradas.get(i).getPlaca());
                this.cbAnoEntrada.setSelectedItem(entradas.get(i).getAno());
                this.cbCorEntrada.setSelectedItem(entradas.get(i).getCor());
                this.DataChooserEntrada.setDate(entradas.get(i).getData_entrada());                  
